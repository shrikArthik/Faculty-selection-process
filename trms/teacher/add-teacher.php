...
$query=$dbh->prepare("SELECT * from tblquery where Email='$email' ||  MobileNumber='$mobnum'");
$query->execute();
...
$sql="insert into tblquery(teacherId,Name,Picture,Email,MobileNumber,Qualifications,Address,TeacherSub,JoiningDate,teachingExp,description)values(:teachid,:tname,:tpics,:email,:mobilenumber,:qualifications,:address,:tsubjects,:joiningdate,:teachingexp,:description)";
$query=$dbh->prepare($sql);
$query->bindParam(':teachid',$trid,PDO::PARAM_STR);
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="form-group"><label for="company" class=" form-control-label">ID </label><input type="text" name="trid" value="" class="form-control" id="trid" required="true"></div>
