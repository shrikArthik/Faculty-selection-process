...
--
-- INSERT INTO `tblquery` (`ID`, `teacherId`, `fName`, `Email`, `MobileNumber`, `Query`, `queryDate`, `teacherNote`,`Picture`,`Name`,`Qualifications`,`Address`,`TeacherSub`,`teachingExp`,`description`,`RegDate`,`isPublic`,`JoiningDate`) VALUES
...
CREATE TABLE `tblteacher` (
  ...
  `RegDate` timestamp NOT NULL DEFAULT current_timestamp(),
  `isPublic` int(1) DEFAULT NULL,
  `status` varchar(200) DEFAULT 'Processing..'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
