...
<head>
    <title>FSP Update Job Posts</title>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="manage-subjects.php">Job Posts</a></li>
...
{               ?>
                                <div class="form-group"><label for="company" class=" form-control-label">Job Post Name</label><input type="text" name="subjects" value="<?php  echo $row->Subject;?>" class="form-control" id="subjects" required="true"></div>
