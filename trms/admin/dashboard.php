...
<head>
    ...
    <title>FSP Admin Dashboard</title>
...
?>
                        ...
                        <p class="text-light">Listed Job posts</p>
...
?>
                        ...
                        <p class="text-light">Registered Candidates</p>
...
?>
                        ...
                        <p class="text-light">Registered Candidates (Private Profile)</p>
...
?>
                        ...
                        <p class="text-light">Registered Candidates (Public Profile)</p>
