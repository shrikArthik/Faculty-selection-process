...
<head>
    ...
    <title>FSP || Manage Subject</title>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="manage-subjects.php">Manage Job Posts</a></li>
                            <li class="active">Manage Job Posts</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Manage Job Posts</strong>
                            </div>
                            <div class="card-body">
                                <table class="table">
                                    <thead>
